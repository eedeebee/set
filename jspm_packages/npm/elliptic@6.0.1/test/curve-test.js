...
describe('Point codec', function() {
  ...
  var shortPointEvenY = {
    ...
    encoded: '04' + '79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798' + '483ada7726a3c4655da4fbfc0e1108a8fd17b448a68554199c47d08ffb10d4b8'
  };
  var shortPointOddY = {
    coordinates: {
    ...
    encoded: '04' + 'fff97bd5755eeea420453a14355235d382f6472f8568a18b2f057a1460297556' + 'ae12777aacfbb620f3be96017f45c560de80f0f6518fe4a03c870c36b075f297'
  };
  it('should throw when trying to decode random bytes', function() {
    assert.throws(function() {
      elliptic.curves.secp256k1.curve.decodePoint('05' + '79be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798');
    });
  });
  it('should be able to encode/decode a short curve point with even Y', makeShortTest(shortPointEvenY));
  it('should be able to encode/decode a short curve point with odd Y', makeShortTest(shortPointOddY));
  it('should be able to encode/decode a mont curve point', makeMontTest({
    ...
    encoded: '26954ccdc99ebf34f8f1dde5e6bb080685fec73640494c28f9fe0bfa8c794531'
  }));
});
